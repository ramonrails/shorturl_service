...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference("ShortUrl.count") do
      post short_urls_url, params: { short_url: { counts: @short_url.counts, last_accessed_at: @short_url.last_accessed_at, shortcode: @short_url.shortcode, url: @short_url.url } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { counts: @short_url.counts, last_accessed_at: @short_url.last_accessed_at, shortcode: @short_url.shortcode, url: @short_url.url } }
